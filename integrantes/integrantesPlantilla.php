...
<body>
  ...
  <ul class="nav nav-tabs">
    ...
    <li class="nav-item dropdown">
        ...
        <a class="dropdown-item active" href="../../NosotrosIntegrantes.php">Integrantes</a>
        </div>
    </li>
    <li class="nav-item dropdown">
	...
	<div align="center">
		<?php
			...
			$sql = "SELECT * FROM perfil WHERE idn='". $idIntegrante ."'";
		...
		<table id="TablaEquipo" border="1" width="900">
			<tr>
				<td colspan="2" align="center">
					<?php 
					echo "<img src='../../img/" . $row['foto'] . "' alt='' height='250'>";
					?>
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td id="FilaPrincipal">Nombres y Apellidos</td>
				<td> <?php echo $row['nombres']." ".$row['apellidos']; ?></td>
			</tr>

			<tr>
				<td id="FilaPrincipal">Descripción del perfil profesional y personal</td>
			...
			<tr>
				<td id="FilaCol" colspan="2" align="center">Información de contacto</td>
			</tr>
			<tr>
